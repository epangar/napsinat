...
describe('Test the behaviour of unique()', function() {
  it('should return [1,2,3] when given [1,2,3,1,2,3,1,2,3].unique() via expect()', function() {
    expect([1, 2, 3, 1, 2, 3, 1, 2, 3].unique()).to.be.equal([1, 2, 3]);
  });
  it('should not return [1,2,3,1,2,3] when given [1,2,3,1,2,3,1,2,3].unique() via expect()', function() {
